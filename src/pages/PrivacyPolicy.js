...
import {EuiText, EuiPage, EuiPageBody, EuiPageContent, EuiPageContentBody} from "@elastic/eui";
            ...
            <EuiPageContentBody>
              <EuiText>
                ...
                <ul>
                  ...
                  <li>
                    <p><strong>Company</strong> (referred to as either &quot;the
                      ...
                      Fontys - Career Jump-Start</p>
                  </li>
                  <li>
                    <p><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any
                      other device by a website, containing the details such as username, role, authentication token
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p><strong>Website</strong> refers to Career Jump-Start, accessible from <a
                        href="https://careerjumpapp.com"
                        target="_blank" rel="noopener noreferrer">https://careerjumpapp.com</a></p>
                  </li>
                  <li>
                ...
                <p>Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address),
                  browser type, browser version the time and date of your
                  registration, unique device identifiers and other diagnostic data.</p>
                ...
                <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on
                  ...
                  as You close Your web browser.</p>
                ...
                <p>Career Jump-Start may use Personal Data for the following purposes:</p>
                <ul>
                  <li>
                    <p><strong>To provide and maintain our Service</strong> The personal information that you provide
                    and the answers to our questionnaire is filled to get a better understanding and about
                    candidate or company's preferences towards their needs and finding a good match.Your data will
                    be visible to our job matchers and later by a company </p>
                  </li>
                  <li>
                    <p><strong>For Candidates:</strong> Your data will
                      be visible to our job matchers and later by the company that you have matched with</p>
                  </li>
                  <li>
                    <p><strong>For Companies:</strong> Your data will
                      be visible to our job matchers and later by the candidate that you have matched with</p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p><strong>To contact You:</strong> To contact You by email, telephone calls or other
                      equivalent forms of electronic communication,
                      regarding updates such as new job offers and matches or other informative communications
                ...
                <p>Your information, including Personal Data, is processed and stored at Amazon Web Service (AWS)' s
                  servers. The data that you provided will be kept only in GDPR-compliant database servers
                  located in Europe, Frankfurt.</p>
                ...
                <p>In case of a data breach, the required local authorities and the users of
                  Career Jump-Start will be notified in 72 hours.</p>
                ...
                <h1>Contact Us</h1>
                <p>If you want us to delete or edit the information after you entered it, or otherwise exercise
                  the rights to your data, or if you have any questions about this Privacy Policy,
                  You can contact us:
                </p>
                <ul>
                  <li>By email: career-jumpstart@fontys.nl</li>
                </ul>
              </EuiText>
            </EuiPageContentBody>
          </EuiPageContent>
