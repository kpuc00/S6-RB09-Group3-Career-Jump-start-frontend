...
import { getSoftFactors, getQuestionsBySoftFactorId, postAnswer, updateSoftFactor } from "./softfactorAPI";
...
export const updateSF = createAsyncThunk(
  ...
  async (params) => {
    ...
    if (response.ok) return { text, updatedSoftFactor: params.updatedSoftFactor };
  }
);
...
export const { selectedSoftFactor } = softfactorSlice.actions;
...
export const selectSoftFactorsLoading = (state) => state.softfactor.loading;
